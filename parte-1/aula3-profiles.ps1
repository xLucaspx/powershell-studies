...
usar a variável $profile. Note que nem sempre este arquivo existe! #>
$profile
...
# ...e para mudarmos seu valor (é necessário rodar o powershell como administrador):
