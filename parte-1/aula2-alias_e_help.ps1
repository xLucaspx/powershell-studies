...
<# Com o argumento -Name, nós conseguimos filtrar os comandos que possuem rename no nome.
(O asterisco atua como coringa para qualquer quantidade de caractere) #>
Get-Command -Name *rename*

# Obtendo ajuda do comando rename-item:
Get-Help Name rename-item

# Com o SwitchArgument -WhatIf podemos saber o que o comando faria antes de o executarmos:
Rename-Item C:\Scripts\script-teste.bat C:\Scripts\script_renomeado.bat -WhatIf

# Sem o SwitchArgument, tudo funciona normalmente:
Rename-Item C:\Scripts\script-teste.bat C:\Scripts\script_renomeado.bat 
...
rename C:\Scripts\script-teste.bat C:\Scripts\script_renomeado.bat
